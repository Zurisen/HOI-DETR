...
#load_from = '/lus/lfs1aip2/home/s5a/ahmad.s5a/projects/Co-DETR/checkpoints/co-dino-coco-detect.pth'
load_from='work_dirs/01_inter_full_low_1e4_corrected_auto80_100_h_f_s_w_3/epoch_5.pth'

#load_from ='/lus/lfs1aip2/home/s5a/ahmad.s5a/projects/Co-DETR/work_dirs/01_inter_full_low_1e4_corrected_auto80_100_h_f_s_w_3_cont/epoch_5.pth'
#load_from = '/lus/lfs1aip2/home/s5a/ahmad.s5a/projects/Co-DETR/checkpoints/pytorch_model_lvis.pth'
#load_from = '/lus/lfs1aip2/home/s5a/ahmad.s5a/projects/Co-DETR/checkpoints/pytorch_model_obj356.bin'
#load_from = '/lus/lfs1aip2/home/s5a/ahmad.s5a/projects/Co-DETR/work_dirs/01_inter_full_low_1e4_corrected_auto80_100_h_f_s_w_3/epoch_5.pth'
#load_from='/lus/lfs1aip2/home/s5a/ahmad.s5a/projects/Co-DETR/work_dirs/inter_full_low_1e4_corrected_auto80_100_all_pairs/epoch_5.pth'
...
#load_from = '/home/s5a/ahmad.s5a/projects/Co-DETR/work_dirs/co_dino_5scale_vit_large_coco_low_00/epoch_1_done.pth'
...
model = dict(
    ...
    query_head=dict(
        ...
        loss_interaction=dict(
            ...
            loss_weight=3,        #default 1,3,6,9,12,15,18
        )
...
data = dict(
    ...
    val=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/egohands_val.json',
             img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/egohands/'),
    test=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/egohands_val.json',
              img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/egohands/')
            )
...
data = dict(
    ...
    train=dict(filter_empty_gt=False, pipeline=train_pipeline,ann_file=data_root + 'annotations/train_h_first_second_full_corrected_auto_80_100.json'),
    val=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/val_h_first_second_full_corrected_w_area_bimanual_only.json'), #val_h_first_second_full_corrected.json, 
    test=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/val_h_first_second_full_corrected_w_area_bimanual_only.json') #val_h_first_second_full_corrected.json
    )
...
data = dict(
    ...
    workers_per_gpu=16, 
    train=dict(filter_empty_gt=False, pipeline=train_pipeline,ann_file=data_root + 'annotations/train_h_first_second_full.json'),
    val=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/wholebody_as_hands23_val_only_exhaustive.json',
             img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/val2017/'),
    test=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/wholebody_as_hands23_val_only_exhaustive.json',
              img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/val2017/')
            )
...
data = dict(
    ...
    workers_per_gpu=16, 
    train=dict(filter_empty_gt=False, pipeline=train_pipeline,ann_file=data_root + 'annotations/train_h_first_second_full.json'),
    val=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/oxford_hands_val_as_hands23.json',
             img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/oxford_hands_images/'),
    test=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/oxford_hands_val_as_hands23.json',
              img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/oxford_hands_images/')
            )
...
data = dict(
    ...
    workers_per_gpu=16, 
    train=dict(filter_empty_gt=False, pipeline=train_pipeline,ann_file=data_root + 'annotations/train_h_first_second_full.json'),
    val=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/wihm_as_hands23_full.json',
             img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/sample_whim/anno/'),
    test=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/wihm_as_hands23_full.json',
              img_prefix='/home/ada/Ahmad/SCRATCH/Ahmad/hands23_data/sample_whim/anno/')
            )



#this is the main training on hands23
data = dict(
    samples_per_gpu=16,
    workers_per_gpu=16,
    collate_fn=dict(type='custom_collate'),#custom_collate
    train=dict(filter_empty_gt=False, pipeline=train_pipeline,ann_file=data_root + 'annotations/train_h_first_second_full_corrected_auto_80_100.json'),
    val=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/val_h_first_second_full_10.json'), #val_h_first_second_full_corrected.json, 
    test=dict(pipeline=test_pipeline,ann_file=data_root + 'annotations/val_h_first_second_full_10.json') #val_h_first_second_full_corrected.json
    )
